...
namespace RoleBasedPermissionJWT.Service.Services
{
    public class TokenService : ITokenService
    {
        ...
        public string GenerateJWT(User user)
        {
            ...
            {
                var rolePermissions = _context.Permissions.Where(x => x.PermissionId == role.RoleId).Select(x => x.PermissionName).ToList();
